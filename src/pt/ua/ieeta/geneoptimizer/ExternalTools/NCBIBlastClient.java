/* $Id: NCBIBlastClient.java 1321 2009-09-04 14:18:23Z hpm $
 * ======================================================================
 ...
 * See:
 * <a
 * href="http://www.ebi.ac.uk/Tools/Webservices/services/sss/ncbiblast">http://www.ebi.ac.uk/Tools/Webservices/services/sss/ncbiblast</a>
 * <a
 * href="http://www.ebi.ac.uk/Tools/Webservices/tutorials/java">http://www.ebi.ac.uk/Tools/Webservices/tutorials/java</a>
 */
public class NCBIBlastClient extends uk.ac.ebi.webservices.AbstractWsToolClient {
     ...
     * Service proxy
     */
    public JDispatcherService srvProxy = null;
    /**
     ...
     */
    private String revision = "$Revision: 1321 $";
    /**
     ...
     */
    public void srvProxyConnect() throws ServiceException {
     ...
     *
     * @param jobid The job identifier.
     * @param outfile The base name of the file to save the results to. If null
     * the jobid will be used.
     * @param outformat The name of the data format to save, e.g. toolraw or
     * toolxml. If null all available data formats will be saved.
