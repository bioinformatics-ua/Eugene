...
/**
 * JFrame to show the user all available genes in the application and allow loading
 * genes to the projects
 *
 * @author Paulo Gaspar
...
public class GenePoolGUI extends javax.swing.JDialog implements Observer, Runnable
{
    ...
    private static GenePoolGUI instance = null;
     ...
     */
    public synchronized static GenePoolGUI getInstance()
    {
        if (instance == null)
        {
    ...
    {//GEN-HEADEREND:event_jLabel3MouseClicked
        ...
        newGene.createStructure(new ByteString(finalSequence), pt.ua.ieeta.geneoptimizer.geneDB.BioStructure.Type.mRNAPrimaryStructure);
    ...
    public void update(Observable o, Object arg)
    {
        ...
        {
            if (!(arg instanceof GenePoolObserverMessage)) return;
